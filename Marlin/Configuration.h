...
#define STRING_CONFIG_H_AUTHOR "(grizzleeadam 7-21-24, Ender-3 Pro)" // Who made the changes.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  19.95,  19.95 }
    #define DEFAULT_Ki_LIST {   1.35,   1.35 }
    #define DEFAULT_Kd_LIST {  73.82,  73.82 }
  #else
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 130.31
  #define DEFAULT_bedKi 24.31
  #define DEFAULT_bedKd 465.65
